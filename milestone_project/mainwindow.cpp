...
void MainWindow::onAddButton()
{
    ...
    {
        statusBar()->showMessage(expt.what());
...
{
    undoShortcut = new QShortcut(QKeySequence(Qt::META + Qt::Key_Z), this);
    redoShortcut = new QShortcut(QKeySequence(Qt::META + Qt::Key_Y), this);
